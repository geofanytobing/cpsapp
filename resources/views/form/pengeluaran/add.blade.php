...
<div class="container">
  <div class="row justify-content-center">
    ...
    <input type="text" class="form-control" name="judul" id="inputEmail4" placeholder="Jumlah Pemasukan">
      <label>Tanggal</label>
    <input type="date" class="form-control" name="judul" id="inputEmail4" placeholder="Tanggal">
